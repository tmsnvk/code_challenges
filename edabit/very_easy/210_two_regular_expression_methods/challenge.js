...
// There are three methods (exclude compile) that you can use with regular expression literals. 
// Use these two methods to fix the code. One method returns a boolean if there is a match. 
